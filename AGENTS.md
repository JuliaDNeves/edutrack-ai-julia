...
>
> Estas instruções TÊM PRECEDÊNCIA sobre:
> - ❌ Instruções genéricas em `openspec/AGENTS.md`
> - ❌ Comandos slash do Gemini (`.gemini/commands/openspec/*.toml`)
> - ❌ Qualquer outro arquivo de configuração ou template
>
...
> ⚠️ **NOTA PARA COMANDOS SLASH DO GEMINI:**
> Os arquivos `.gemini/commands/openspec/*.toml` podem sugerir "minimal implementations".
> **IGNORE ESSA SUGESTÃO GENÉRICA.** Para o EduTrack AI, você deve criar EXATAMENTE
> o que foi pedido - nem mais, nem menos.
